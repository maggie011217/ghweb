...
<TABLE class=dragTable id=viewarticle cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  ...
  <TR>
    <TD class=head>
            <H3 class=L></H3><FONT 
                        color=#000000>您現在的位置:<SPAN 
                        style="TEXT-DECORATION: none"> 會員登入 &gt;&gt; 找回密碼</FONT>
	</TD>
	</TR>
  </TBODY>
</TABLE>
        ...
        <TR>
          <TD><FORM name="form1" action="<%=basePath%>Member" method="post">
            ...
            <TBODY>
              ...
              <TR class=black >
                <TD align=right width="38%"  height=30>提示問題:<input type=hidden name=reg_type value=person></TD>
                <TD width="62%"  height=30 align=left>
				<INPUT class=inputb   size=22 name=question >
				</TD>
				</TR>
              <TR class=black >
                <TD align=right width="38%"  height=30>問題答案:</TD>
                <TD width="62%"  height=30 align=left>
