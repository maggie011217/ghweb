...
<BODY text=#000000 bgColor=#ffffff leftMargin=0 topMargin=0>
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD width=350 align=right>服務類別：</TD><TD align=left><select name="ks">
    ...
    <%}} %>
		...
		<TR>
          <TD  align=right>美甲師姓名關鍵字：</TD><TD align=left><input type=text name=xm size=30 ></TD>
		</TR> 
		<TR>
          <TD  align=center colspan=2><input type=button onclick="f111()" value="查詢資料"></TD>
		</TR>
				</TBODY>
			</TABLE>
			</form>			
