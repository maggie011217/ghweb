...
<TABLE  cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD align="left" vAlign=top >
	  ...
	  <form action="<%=basePath %>member/gh/sinfo.jsp" method="post" name="form" onsubmit="return abc()" >  
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  <TBODY> 
		  <TR align="center" bgColor=#ffffff>
			<TD  align="center" >查詢類型：<select name=lx>  
        <option value="xm">美甲師名</option>
        <option value="bh">預約編號</option>
        <option value="ks">服務</option>
        <option value="sj">預約日期</option> 
        </select> 查詢內容：<input type=text size=20 name=word > <input type="submit" value="提交"> 如按日期查詢，請注意日期格是為：0000-00-00</TD>
		  </TR> 
		</TBODY>
	   </TABLE>
	  </form>
