    ...
    <TD vAlign=top align=middle>
      <TABLE  height=24 cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          ...
          <a href="<%=basePath %>member/iframe/main.jsp" target="MainFrame">管理首頁</a></TD></TR></TBODY></TABLE>
...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TABLE width="100%" border="0" align="center"style="cursor:hand" onclick=javascript:expand(1)>
    ...
    <TD background="<%=basePath %>member/images/linkbg1.gif" > <a href="<%=basePath %>" target="_top">返回網站首頁</a></TD></TR>
    </TABLE>
  </TD>
  </TR>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" ><a href="<%=basePath %>member/gh/index.jsp" target="MainFrame">查看預約資料</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" ><a href="<%=path%>/Login?method=memberexit" target="_top">登出</a></TD></TR>
  </TABLE>
