      ...
      <TABLE height="100%" cellSpacing=2 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD align=right width=109>
            <DIV id=st title=全螢幕/半螢幕 style="CURSOR: hand" 
            onclick=ChangeLeftFrameStatu(); align=center><FONT 
            color=red>×</FONT> 關閉左邊欄位</DIV></TD>
...
<SCRIPT language=javascript>    var screen=false;i=0;width=0;    function ChangeLeftFrameStatu()    {        if(screen==false)        {            parent.FrameMain.cols='0,*';            screen=true;            self.st.innerHTML = "√ 打開左邊欄位"        }        else if(screen==true)        {            parent.FrameMain.cols='165,*';           screen=false;            self.st.innerHTML = "<font color=red>×</font> 關閉左邊欄位"        }    }</SCRIPT>
</BODY>
<%} %>
</HTML>
