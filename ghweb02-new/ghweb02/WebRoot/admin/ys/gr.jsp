...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
  <TR>
    <TD align="left" vAlign=top ><form name="form1" action="<%=basePath %>News" method="post"  enctype="multipart/form-data"  onsubmit="return sub()">
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
  <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">美甲師編號：</div></td>
  ...
  <tr bgcolor='#FFFFFF'> <input type="hidden" name="method" value="<%=method %>"> <input type="hidden" name="id" value="<%=id %>">
    <td width='30%'><div align="right">美甲師姓名：</div></td>
    <td ><input name="xm" type="text" size="40" maxlength="100" value="<%=xm %>"></td>
  </tr>
  <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">服務類別：</div></td>
    <td ><select name="ks">
  ...
  <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">上傳照片：</div></td>
    <td ><input name="pic" type="file"   size="40" maxlength="150" > </td>
  </tr>
  <tr bgcolor='#FFFFFF'>  
    <td width='30%'><div align="right">美甲費用：</div></td>
  ...
  <td width='30%'><div align="right">美甲師介紹：</div></td>
   ...
   <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">上班時間：</div></td>
    <td><input name="sj" type="text"  size="40" maxlength="100" value="<%=sj %>" > </TD>
  </tr> 
  <tr bgcolor='#FFFFFF'> 
      <td colspan="2" align="center"> 
        <input class=mmcinb type='submit' name='button' value='送出' >
      </td>
    </tr>
