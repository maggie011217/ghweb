...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>ComServlet?method=delFenLei&id=<%=pagelist2.get(0).toString()%>">刪除</a></td>
    </tr>
...
<p align=center>分類名稱：<input name="bj" type="text" size="30" maxlength="100" > 
<input class=mmcinb type='button' name='button' value='送出' onclick='sub()'>
</form>	
</BODY>
<%} %>
</HTML>
