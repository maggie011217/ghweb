...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
  <tr bgcolor='#FFFFFF'> <input type="hidden" name="method" value="<%=method %>"> <input type="hidden" name="id" value="<%=id %>">
    <td width='40%'><div align="right">排班專家</div></td>
    <td ><select name="ys">
  ...
  <tr bgcolor='#FFFFFF'>  
    <td width='40%'><div align="right">排班服務</div></td>
    <td ><select name="ks">
  ...
  <tr bgcolor='#FFFFFF'> 
    <td width='40%'><div align="right">排班時間</div></td>
    <td ><select name=xx>
  ...
  <tr bgcolor='#FFFFFF'> 
      <td colspan="2" align="center"> 
        <input class=mmcinb type='button' name='button' value='提交' onclick='sub()'>
      </td>
    </tr>
