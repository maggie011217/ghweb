...
<BODY text=#000000 bgColor=#ffffff leftMargin=0 topMargin=0>
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from ys where ks='"+ks+"' and xm like '%"+xm+"%'  order by id desc",10); //带进一个頁数，并返回该頁所要显示的信息 
